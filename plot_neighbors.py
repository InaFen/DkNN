...
from utils.utils_plot import plot_member_non_member_layer_experiments_scatter, plot_mean_layer_experiments_all, plot_member_non_member_experiments_histogram
...
plot_member_non_member_layer_experiments_scatter(sum_similarities_knns_layers_member_all_experiments, sum_similarities_knns_layers_non_member_all_experiments, experiment_setups, 0, "/home/inafen/jupyter_notebooks/similarities_knns_0.png", train_accuracy, test_accuracy, ylabel= "Sum of similar knns", suptitle = "Sum of similar knns (= nns, that stay knns) btw. layer {} & {}")
plot_member_non_member_layer_experiments_scatter(sum_similarities_knns_layers_member_all_experiments, sum_similarities_knns_layers_non_member_all_experiments, experiment_setups, 1, "/home/inafen/jupyter_notebooks/similarities_knns_1.png", train_accuracy, test_accuracy, ylabel= "Sum of similar knns", suptitle = "Sum of similar knns (= nns, that stay knns) btw. layer {} & {}")
plot_member_non_member_layer_experiments_scatter(sum_similarities_knns_layers_member_all_experiments, sum_similarities_knns_layers_non_member_all_experiments, experiment_setups, 2, "/home/inafen/jupyter_notebooks/similarities_knns_2.png", train_accuracy, test_accuracy, ylabel= "Sum of similar knns", suptitle = "Sum of similar knns (= nns, that stay knns) btw. layer {} & {}")
plot_member_non_member_layer_experiments_scatter(sum_similarities_knns_layers_member_all_experiments, sum_similarities_knns_layers_non_member_all_experiments, experiment_setups, 3, "/home/inafen/jupyter_notebooks/similarities_knns_3.png", train_accuracy, test_accuracy, ylabel= "Sum of similar knns", suptitle = "Sum of similar knns (= nns, that stay knns) btw. layer {} & {}")
