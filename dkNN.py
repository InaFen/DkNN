...
class DkNNModel(Model):
  def __init__(self, neighbors, layers, get_activations, train_data, train_labels, nb_classes=10, nb_tables=200, number_bits=17, back_end = NearestNeighbor.BACKEND.FALCONN, nb_cali = -1):
    """
